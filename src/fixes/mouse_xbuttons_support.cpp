...
static UWindowsViewport_ViewportWndProc_t orig_ViewportWndProc = nullptr;

typedef signed int(__thiscall* UWindowsViewport_CauseInputEvent_t)(char* pThis, INT iKey, INT Action, FLOAT Delta);
static UWindowsViewport_CauseInputEvent_t orig_CauseInputEvent = nullptr;
...
static safetyhook::InlineHook sh_ViewportWndProc;
static safetyhook::InlineHook sh_CauseInputEvent;
...
void MouseXButtonsSupport::Initialize() const
{
