...
// P_3_4_3_Sev_Masse
//=============================================================================
class P_3_4_3_Sev_Masse extends EPattern;
...
InteractComp:
    ...
    SetFlags(V3_4_3Severonickel(Level.VarObject).SafeToKillMasse,TRUE);
    Sleep(0.1);
    Close();
...
TimerEnded:
    Log("Timer Ended");
    CheckFlags(V3_4_3Severonickel(Level.VarObject).SafeToKillMasse,TRUE,'DoNothing');
