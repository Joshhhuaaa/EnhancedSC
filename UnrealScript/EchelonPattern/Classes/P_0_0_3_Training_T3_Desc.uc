...
OpenDoor01:
    ...
    {
        AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1006L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_MOVE_DOWN_MASK | KEY_INTERACTION_MASK, FALSE);
    }
    else
    {
        AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1007L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_MOVE_DOWN_MASK | KEY_INTERACTION_MASK, FALSE);
    }
    End();
LockPick02:
    Log("LockPick02");
    if (EchelonGameInfo(Level.Game).bUseController)
    {
        if (EchelonGameInfo(Level.Game).bNewDoorInteraction)
        {
            AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_0004L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK, TRUE);
        }
        else
        {
            AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1001L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_MOVE_UP_MASK | KEY_MOVE_DOWN_MASK | KEY_MOVE_LEFT_MASK | KEY_MOVE_RIGHT_MASK | KEY_QUICK_MASK, FALSE);
            AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1005L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_FIRE_MASK, FALSE);
        }
        AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1002L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_MOVE_UP_MASK | KEY_MOVE_DOWN_MASK | KEY_MOVE_LEFT_MASK | KEY_MOVE_RIGHT_MASK, FALSE);
        AddTrainingData(Localize("P_0_0_3_Training_T3_Desc", "Training_1003L", "Localization\\P_0_0_3_Training"), KEY_NONE_MASK | KEY_MOVE_UP_MASK | KEY_MOVE_DOWN_MASK | KEY_MOVE_LEFT_MASK | KEY_MOVE_RIGHT_MASK, FALSE);
    }
    else
    {
        if (EchelonGameInfo(Level.Game).bNewDoorInteraction)
