//=============================================================================
// P_3_4_1a_Sev_Alekseevich
//=============================================================================
class P_3_4_1a_Sev_Alekseevich extends EPattern;
...
ColonelArrival:
    ...
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0004L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_01', 1, 0, TR_CONVERSATION, 0, false);
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0005L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_02', 2, 0, TR_CONVERSATION, 0, false);
    Goal_Set(1,GOAL_Action,9,,,,,'TalkStNmCC0',FALSE,,,,);
    Goal_Set(1,GOAL_Action,8,,,,,'TalkStNmCC0',FALSE,,,,);
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0006L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_03', 1, 0, TR_CONVERSATION, 0, false);
    Goal_Set(2,GOAL_Action,9,,,,,'TalkStNmBB0',FALSE,,,,);
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0007L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_04', 2, 0, TR_CONVERSATION, 0, false);
    Goal_Set(1,GOAL_Action,9,,,,,'TalkStNmAA0',FALSE,,,,);
    Goal_Set(3,GOAL_Stop,9,,,,,,FALSE,0.5,,,);
    Goal_Set(3,GOAL_Action,8,,,,,'PrsoStNmEE0',FALSE,,,,);
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0008L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_05', 1, 0, TR_CONVERSATION, 0, false);
    Speech(Localize("P_3_4_1a_Sev_Alekseevich", "Speech_0009L", "Localization\\P_3_4_1Severonickel"), Sound'S3_4_2Voice.Play_34_24_06', 2, 0, TR_CONVERSATION, 0, false);
    Close();
    ...
    Sleep(1.5);
    CinCamera(1, , ,);
    SendPatternEvent('LambertAI','AlexIsComing');
