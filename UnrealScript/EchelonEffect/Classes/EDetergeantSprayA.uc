class EDetergeantSprayA extends Emitter;

defaultproperties
{
    Begin Object Class=MeshEmitter Name=DetergeantSprayA0
        StaticMesh=StaticMesh'EMeshSFX.Item.Detergeant_spray_0102PART'
        ...
        StartVelocityRange=(X=(Min=-100.000000,Max=100.000000),Y=(Min=-100.000000,Max=100.000000),Z=(Min=75.000000,Max=250.000000))
        Name="DetergeantSprayA0"
    End Object
    Emitters(0)=MeshEmitter'EchelonEffect.DetergeantSprayA0'
    bUnlit=false
}